...
import 'dashboard_users_model.dart';
export 'dashboard_users_model.dart';

class DashboardUsersWidget extends StatefulWidget {
  const DashboardUsersWidget({super.key});

  @override
  State<DashboardUsersWidget> createState() => _DashboardUsersWidgetState();
}

class _DashboardUsersWidgetState extends State<DashboardUsersWidget> {
  late DashboardUsersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardUsersModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'DashboardUsers'});
                          ...
                          children: [
                            Flexible(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'DASHBOARD_USERS_Image_pysf1jnu_ON_TAP');
              ...
              child: Align(
                ...
                child: StreamBuilder<List<UserRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<UserRecord> maxWidthUserRecordList = snapshot.data!;
                                              ...
                                              children: [
                                                TextFormField(
                                                  ...
                                                  onChanged: (_) =>
                                                    ...
                                                    () async {
                                                      logFirebaseEvent(
                                                          'DASHBOARD_USERS_filterTextField_ON_TEXTF');
                                                      logFirebaseEvent(
                                                ...
                                                Align(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child:
                                                      ...
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'DASHBOARD_USERS_PAGE_clear_ICN_ON_TAP');
                                                        logFirebaseEvent(
                                                      ...
                                                      return ListView.builder(
                                                        ...
                                                        itemCount:
                                                            filteredChildren
                                                                .length,
                                                        itemBuilder: (context,
                                                            filteredChildrenIndex) {
                                                          final filteredChildrenItem =
                                                              filteredChildren[
                                                                  filteredChildrenIndex];
                                                          return Padding(
                                                            padding:
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'DASHBOARD_USERS_Container_4fovmu6w_ON_TA');
                                                                logFirebaseEvent(
                                                                    'Container_update_page_state');
                                                                _model.currentUserDoc =
                                                                    filteredChildrenItem;
                                                                              ...
                                                                              Expanded(
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Column(
                                                                                    ...
                                                                                    children: [
                                                                                      Text(
                                                                                        filteredChildrenItem.displayName,
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            dateTimeFormat("yMMMd",
                                                                                filteredChildrenItem.createdTime!),
                                                                      ...
                                                                      if (responsiveVisibility(
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            valueOrDefault<String>(
                                                                              dateTimeFormat("relative", filteredChildrenItem.lastLoginTime),
                                                                              'No login',
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).titleLarge.override(
                                                                                  fontFamily: 'Inter Tight',
                                                      ...
                                                      return ListView.builder(
                                                        ...
                                                        itemCount:
                                                            unfilteredChildren
                                                                .length,
                                                        itemBuilder: (context,
                                                            unfilteredChildrenIndex) {
                                                          final unfilteredChildrenItem =
                                                              unfilteredChildren[
                                                                  unfilteredChildrenIndex];
                                                          return Padding(
                                                            padding:
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'DASHBOARD_USERS_Container_85mld69k_ON_TA');
                                                                logFirebaseEvent(
                                                                    'Container_update_page_state');
                                                                _model.userSidebarOpen =
                                                                    true;
                                                                _model.currentUserDoc =
                                                                    unfilteredChildrenItem;
                                                                safeSetState(
                                                                    () {});
                                                              },
                                                              child: Container(
                                                                            ...
                                                                            children: [
                                                                              Padding(
                                                                                ...
                                                                                child: ClipRRect(
                                                                                  ...
                                                                                  child: Image.network(
                                                                                    valueOrDefault<String>(
                                                                                      unfilteredChildrenItem.photoUrl,
                                                                                      'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/one-hundred-x-dxpmh3/assets/urudd5qbm9oj/blank-200.jpeg',
                                                                                    ),
                                                                                    width: 32.0,
                                                                                    height: 32.0,
                                                                              ...
                                                                              Expanded(
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Column(
                                                                                    ...
                                                                                    children: [
                                                                                      Text(
                                                                                        unfilteredChildrenItem.displayName,
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                      ...
                                                                      if (responsiveVisibility(
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            dateTimeFormat("yMMMd",
                                                                                unfilteredChildrenItem.createdTime!),
                                                                            style: FlutterFlowTheme.of(context).titleLarge.override(
                                                                      ...
                                                                      if (responsiveVisibility(
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            valueOrDefault<String>(
                                                                              dateTimeFormat("relative", unfilteredChildrenItem.lastLoginTime),
                                                                              'No login',
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).titleLarge.override(
                                                                                  fontFamily: 'Inter Tight',
                                                                              ...
                                                                              children: [
                                                                                Container(
                                                                                  ...
                                                                                  child: Padding(
                                                                                    padding: EdgeInsetsDirectional.fromSTEB(12.0, 0.0, 12.0, 0.0),
                                                                                    child: Text(
                                                                                      unfilteredChildrenItem.userRole,
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: 'Plus Jakarta Sans',
                                                                                            color: Color(0xFF15161E),
                                                                                            fontSize: 14.0,
                                                ...
                                                children: [
                                                  ...
                                                  Align(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'DASHBOARD_USERS_PAGE_closeIcon_ON_TAP');
                                                        logFirebaseEvent(
