...
import 'dashboard_content_model.dart';
export 'dashboard_content_model.dart';
...
class _DashboardContentWidgetState extends State<DashboardContentWidget> {
  late DashboardContentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardContentModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'DashboardContent'});
                          ...
                          children: [
                            Flexible(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'DASHBOARD_CONTENT_Image_helfjeqo_ON_TAP');
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'DASHBOARD_CONTENT_ADD_NEW_BTN_ON_TAP');
                                              logFirebaseEvent(
                                                  'Button_update_page_state');
                                              _model.contentSidebarOpen = true;
                                              safeSetState(() {});
                                            },
                                            text: 'Add New',
                                            icon: Icon(
                                      ...
                                      PagedListView<DocumentSnapshot<Object?>?,
                                        ...
                                        pagingController:
                                          ...
                                          TribeContentRecord.collection.orderBy(
                                              'publishDate',
                                              descending: true),
                                        ),
                                        ...
                                        builderDelegate:
                                          ...
                                          itemBuilder:
                                            ...
                                            final listViewTribeContentRecord =
                                                _model
                                            ...
                                            return Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'DASHBOARD_CONTENT_Container_in9tdk4a_ON_');
                                                  logFirebaseEvent(
                                                      'Container_update_page_state');
                                                  _model.currentContentDoc =
                                                      listViewTribeContentRecord;
                                                  _model.contentSidebarOpen =
                                                      true;
                                                  safeSetState(() {});
                                                },
                                                child: Container(
                                    ...
                                    children: [
                                      Align(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'DASHBOARD_CONTENT_Icon_8wg09b11_ON_TAP');
                                            logFirebaseEvent(
                                                'Icon_update_page_state');
                                            _model.contentSidebarOpen = false;
                                            safeSetState(() {});
                                          },
                                          child: Icon(
                                            Icons.close,
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          _model.currentContentDoc?.title,
                                          'Nothing Selected',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
