...
class _ProfileWidgetState extends State<ProfileWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('profile_wait__delay');
      await Future.delayed(const Duration(milliseconds: 500));
      logFirebaseEvent('profile_firestore_query');
    ...
    _model.displayNameEditTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      currentUserDisplayName,
      'Name ',
    ));
    _model.displayNameEditFocusNode ??= FocusNode();
            ...
            appBar: responsiveVisibility(
                ...
                ? AppBar(
                    ...
                    leading: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent('PROFILE_PAGE_Icon_gvqxr4xu_ON_TAP');
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'PROFILE_PAGE_ImageUpload_ON_TAP');
                                                      logFirebaseEvent(
                                                          'ImageUpload_upload_media_to_firebase');
                                                      final selectedMedia =
                                                      ...
                                                      safeSetState(() {});
                                                      logFirebaseEvent(
                                                          'ImageUpload_backend_call');
                                                      _model.uploadimageResponse =
                                                          await UpdateUserImageCall
                                                              .call(
                                                      ...
                                                      if ((_model
                                                        ...
                                                        logFirebaseEvent(
                                                            'ImageUpload_google_analytics_event');
                                                        logFirebaseEvent(
                                                          'UserUploadedProfileImg',
                                                          parameters: {
                                                            'userRef':
                                                                    ...
                                                                    AuthUserStreamWidget(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                            TextFormField(
                                                                          controller:
                                                                              _model.displayNameEditTextController,
                                                                          focusNode:
                                                                              _model.displayNameEditFocusNode,
                                                                          autofocus:
                                                                              false,
                                                                          obscureText:
                                                                              false,
                                                                    ...
                                                                    AuthUserStreamWidget(
                                                                      builder:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'PROFILE_PAGE_NoNameSet_ON_TAP');
                                                                          logFirebaseEvent(
                                                                              'NoNameSet_update_app_state');
                                                                          FFAppState().profileEdit =
                                                                              true;
                                                                          FFAppState()
                                                                              .update(() {});
                                                                        },
                                                        ...
                                                        if (!FFAppState()
                                                          ...
                                                          FlutterFlowIconButton(
                                                            ...
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'PROFILE_PAGE_EditIcon_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'EditIcon_update_app_state');
                                                              FFAppState()
                                                                      .profileEdit =
                                                                  true;
                                                              FFAppState()
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'PROFILE_PAGE_SaveButton_ON_TAP');
                                                            logFirebaseEvent(
                                                            ...
                                                            logFirebaseEvent(
                                                                'SaveButton_update_app_state');
                                                            FFAppState()
                                                                    .profileEdit =
                                                                false;
                                                            safeSetState(() {});
                                                            logFirebaseEvent(
                                                                'SaveButton_show_snack_bar');
                                                            ScaffoldMessenger
                                                                    .of(context)
                                                                .showSnackBar(
                                                              SnackBar(
                                                    ...
                                                    child: Material(
                                                      ...
                                                      child: SwitchListTile
                                                        ...
                                                        onChanged:
                                                          ...
                                                          if (newValue!) {
                                                            logFirebaseEvent(
                                                                'PROFILE_SwitchListTile_54g348hw_ON_TOGGL');
                                                            logFirebaseEvent(
                                                        ...
                                                        subtitle: Text(
                                                          'Receive notifications from our applications.',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodySmall
                                                              .override(
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'PROFILE_PAGE_CONTACT_SUPPORT_BTN_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Button_launch_u_r_l');
                                                            await launchURL(
                                                                getRemoteConfigString(
                                              ...
                                              children: [
                                                ...
                                                if (isAndroid)
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'PROFILE_PAGE_GooglePlayStore_ON_TAP');
                                                      logFirebaseEvent(
                                                          'GooglePlayStore_launch_u_r_l');
                                                      await launchURL(
                                                          getRemoteConfigString(
                                                              'UpdateAndroidAppURL'));
                                                    },
                                                ...
                                                if (isiOS)
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'PROFILE_PAGE_AppStore_ON_TAP');
                                                      logFirebaseEvent(
                                                          'AppStore_launch_u_r_l');
                                                      await launchURL(
                                                          getRemoteConfigString(
                                                              'UpdateiOSAppURL'));
                                                    },
                                                    text: 'Check App Store',
                                                    icon: Icon(
                                                      Icons.phone_iphone,
                                                      color:
                                                          FlutterFlowTheme.of(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'PROFILE_DELETE_ALL_ACCOUNT_DATA_BTN_ON_T');
                                                logFirebaseEvent(
                                                    'Button_alert_dialog');
