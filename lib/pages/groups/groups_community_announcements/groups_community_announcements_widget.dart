...
import 'groups_community_announcements_model.dart';
export 'groups_community_announcements_model.dart';

class GroupsCommunityAnnouncementsWidget extends StatefulWidget {
  const GroupsCommunityAnnouncementsWidget({
    super.key,
    this.groupDoc,
  });
  ...
  @override
  State<GroupsCommunityAnnouncementsWidget> createState() =>
      _GroupsCommunityAnnouncementsWidgetState();
}

class _GroupsCommunityAnnouncementsWidgetState
    extends State<GroupsCommunityAnnouncementsWidget> {
  late GroupsCommunityAnnouncementsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GroupsCommunityAnnouncementsModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'GroupsCommunity_Announcements'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('GROUPS_COMMUNITY_ANNOUNCEMENTS_GroupsCom');
      logFirebaseEvent('GroupsCommunity_Announcements_update_app');
        ...
        floatingActionButton: Visibility(
          ...
          child: AuthUserStreamWidget(
            builder: (context) => FloatingActionButton.extended(
              onPressed: () async {
                logFirebaseEvent('GROUPS_COMMUNITY_ANNOUNCEMENTS_FloatingA');
                  ...
                  children: [
                    Padding(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'GROUPS_COMMUNITY_ANNOUNCEMENTS_groups_IC');
                                                  ...
                                                  Expanded(
                                                    child: Builder(
                                                      builder: (context) =>
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'GROUPS_COMMUNITY_ANNOUNCEMENTS_Container');
                                                          logFirebaseEvent(
                                                                        ...
                                                                        if (currentUserPhoto !=
                                                                          ...
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              onTap: () async {
                                                                                logFirebaseEvent('GROUPS_COMMUNITY_ANNOUNCEMENTS_UsersIMG_');
                                          ...
                                          child: Padding(
                                            ...
                                            child: StreamBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<BroadcastsRecord>
                                                    queryContainerBroadcastsRecordList =
                                                    snapshot.data!;
                                                  ...
                                                  child: AuthUserStreamWidget(
                                                    builder: (context) =>
                                                      ...
                                                      builder: (context) {
                                                        ...
                                                        if (broadcasts
                                                            .isEmpty) {
                                                          return EmptyCommunityPostWidget(
                                                            groupId: widget!
                                                                .groupDoc!
                                                                .tribeGroupID,
                                                            groupCategories:
                                                          ...
                                                          itemBuilder: (context,
                                                            ...
                                                            return wrapWithModel(
                                                              ...
                                                              child:
                                                                  FeedPostItemWidget(
                                                                key: Key(
                                                                  'Keyvy8_${broadcastsItem.reference.id}',
                                                                ),
                                                                broadcastDoc:
                                                                    broadcastsItem,
                                                                groupDoc: widget!
