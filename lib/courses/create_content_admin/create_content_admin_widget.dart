...
import 'create_content_admin_model.dart';
export 'create_content_admin_model.dart';

class CreateContentAdminWidget extends StatefulWidget {
  const CreateContentAdminWidget({
    super.key,
    this.authorRef,
    this.groupRef,
    this.isEdit,
  ...
  final int? groupId;
  final bool? enableTodo;
  final int? tribeContentId;

  @override
  State<CreateContentAdminWidget> createState() =>
      _CreateContentAdminWidgetState();
}

class _CreateContentAdminWidgetState extends State<CreateContentAdminWidget> {
  late CreateContentAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateContentAdminModel());
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'CREATE_CONTENT_ADMIN_close_ICN_ON_TAP');
                  ...
                  if (widget!.featuredVideo != null &&
                      widget!.featuredVideo != '')
                    Align(
                      alignment: AlignmentDirectional(0.0, 0.0),
                      child: FlutterFlowVideoPlayer(
                        path:
                            '${getRemoteConfigString('cdnBaseUrl')}${widget!.featuredVideo}',
                  ...
                  Text(
                    'This content will be added to your Group.',
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'Text for an optional button',
                          hintStyle: FlutterFlowTheme.of(context)
                              .bodySmall
                              .override(
                                fontFamily: FlutterFlowTheme.of(context)
                    ...
                    children: [
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'CREATE_CONTENT_ADMIN_Date_New_ON_TAP');
                            logFirebaseEvent('Date_New_date_time_picker');
                            final _datePickedDate = await showDatePicker(
                              context: context,
                              initialDate:
                                  (widget!.publishDateTime ?? DateTime.now()),
                  ...
                  Row(
                    ...
                    children: [
                      Theme(
                        ...
                        child: Checkbox(
                          value: _model.checkboxValue ??= widget!.enableTodo!,
                          onChanged: (newValue) async {
                            safeSetState(
                                () => _model.checkboxValue = newValue!);
                            if (newValue!) {
                              logFirebaseEvent(
                                  'CREATE_CONTENT_ADMIN_Checkbox_o56v7f38_O');
                              logFirebaseEvent('Checkbox_backend_call');

                              await widget!.contentRef!
                      ...
                      children: [
                        if (!widget!.isEdit!)
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CREATE_CONTENT_ADMIN_CREATE_CONTENT_BTN_');
                        ...
                        if (widget!.isEdit ?? true)
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CREATE_CONTENT_ADMIN_UPDATE_CONTENT_BTN_');
                              logFirebaseEvent('Button_show_snack_bar');
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'CREATE_CONTENT_ADMIN_DELETE_POST_BTN_ON_');
                            ...
                            await widget!.contentRef!.delete();
                            logFirebaseEvent('Button_bottom_sheet');
                            Navigator.pop(context);
                          },
                          text: 'Delete Post',
