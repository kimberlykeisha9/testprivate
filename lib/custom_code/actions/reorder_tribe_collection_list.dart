...
Future reorderTribeCollectionList(
  List<TribeCollectionRecord> list,
  int oldIndex,
  int newIndex,
) async {
  ...
  final TribeCollectionRecord item = list.removeAt(oldIndex);
  ...
  for (int i = 0; i < list.length; i++) {
    final TribeCollectionRecord doc = list[i];
