...
import 'message_types_link_test_model.dart';
export 'message_types_link_test_model.dart';

class MessageTypesLinkTestWidget extends StatefulWidget {
  const MessageTypesLinkTestWidget({
    super.key,
  ...
  @override
  State<MessageTypesLinkTestWidget> createState() =>
      _MessageTypesLinkTestWidgetState();
}

class _MessageTypesLinkTestWidgetState
    extends State<MessageTypesLinkTestWidget> {
  late MessageTypesLinkTestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MessageTypesLinkTestModel());
                ...
                if (widget!.message!.images.length >= 2) {
                                  ...
                                  child: Container(
                                    ...
                                    child: Container(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'MESSAGE_TYPES_LINK_TEST_Image_q42h08lm_O');
                                          logFirebaseEvent(
                                              'Image_expand_image');
                  ...
                  return Container(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'MESSAGE_TYPES_LINK_TEST_Image_vxbwqn5w_O');
